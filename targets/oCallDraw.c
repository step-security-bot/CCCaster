...
extern "C" {
    ...
    int loadTextureFromMemory( char* imgbuf1, int img1size, char* imgbuf2, int img2size, int param4 ) {
        return (*createTexFromFileInMemory)( img1size, imgbuf2, img2size, param4 );
    }
}
